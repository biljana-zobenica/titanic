...
model_filepath = os.path.join(model_path, 'lr_model.pk1')
scaler_filepath = os.path.join(model_path, 'lr_scaler.pk1')
...
columns = [u'Age', u'Fare', u'FamilySize', \
           ...
           u'Pclass_3', u'Title_Lady', u'Title_Mister', u'Title_Miss',  u'Title_Mr', \
...
def make_prediction():
    ...
    data = json.dumps(request.get_json(force=True)) #.encode('utf8')
